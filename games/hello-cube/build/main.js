(() => {
  ...
  var rotationSpeed = { x: 0.01, y: 0.01 };
  function init() {
    ...
    scene.add(cube);
    const wireGeometry = new BoxGeometry(2.1, 2.1, 2.1);
  ...
  function setupEventListeners() {
    ...
    canvas.addEventListener("mousemove", (e) => {
      ...
      rotationSpeed.x = deltaMove.y * 5e-3;
      rotationSpeed.y = deltaMove.x * 5e-3;
      previousMousePosition = { x: e.clientX, y: e.clientY };
    });
  ...
  start();
  window.__GAME_INSTANCE__ = { start, stop };
})();
