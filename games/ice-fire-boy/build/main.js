(() => {
  // games/ice-fire-boy/src/main.ts
  var config = {
    type: Phaser.AUTO,
    width: 800,
    height: 600,
  ...
  function create() {
    ...
    createLevel(this);
    playerIce = this.physics.add.image(100, 450, "ice-player").setCollideWorldBounds(true).setMaxVelocity(300, 300).setBounce(0.1);
    playerFire = this.physics.add.image(150, 450, "fire-player").setCollideWorldBounds(true).setMaxVelocity(300, 300).setBounce(0.1);
  ...
  function update() {
    if (!playerIce.active || !playerFire.active)
      return;
  ...
  function createLevel(scene) {
    scene.add.rectangle(400, 580, 800, 40, 1710638);
  ...
  function collectIceGem(player, gem) {
    gem.disableBody(true, true);
    score += 10;
    scoreText.setText("\u5206\u6570\uFF1A" + score);
  }
  function collectFireGem(player, gem) {
    gem.disableBody(true, true);
    score += 10;
    scoreText.setText("\u5206\u6570\uFF1A" + score);
  }
  function hitLava(player, spike) {
